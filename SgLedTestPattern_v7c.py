...
if half_tile_bool == True:
    ...
    for left in range(0, wallPanelWidth2, tileResWidth * 2):
        for top in range((wallPanelHeight2 - int(tileResHeight/2)), wallPanelHeight2, int(tileResHeight/2) * 2):
            wallIm.paste(tile_color_1, (left, top))
    for leftAlt in range(tileResWidth, wallPanelWidth2, tileResWidth * 2):
        for topAlt in range((wallPanelHeight2 - (int(tileResHeight/2))), wallPanelHeight2, tileResHeight * 2):
